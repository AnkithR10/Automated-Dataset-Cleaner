...
function LandingPage() {
  ...
  // Render centered Auth Login Card (strictly flex-centered, no absolute positioning)
  // Force authentication modal on load if not authenticated.
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-slate-50 dark:bg-slate-950 px-4 sm:px-6 lg:px-8 py-8 w-full">
        <LoginCard 
          ...
          // onClose omitted to make it non-dismissible
        />
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 antialiased font-sans flex flex-col justify-between transition-colors duration-300">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 flex-1 flex flex-col justify-center items-center w-full">
        <div className="max-w-4xl w-full text-center flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-blue-50 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-xs font-semibold mb-6 shadow-sm">
            <Sparkles size={12} className="text-blue-600 dark:text-blue-400" /> Version 2.0 Released
          </div>

          <h1 className="text-4xl sm:text-6xl font-black text-slate-900 dark:text-white tracking-tight leading-none mb-6">
            Automated <span className="text-blue-600">Dataset Cleaner</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16 justify-center w-full max-w-md">
            {isAuthenticated ? (
              <button
                ...
                className="flex-1 px-4 py-2 text-sm font-medium rounded-lg bg-blue-600 hover:bg-blue-700 text-white shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-1.5 text-sm cursor-pointer"
              >
          ...
          <div id="features" className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl text-left mt-4">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
              <div className="h-9 w-9 bg-blue-50 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg flex items-center justify-center mb-4">
                <Layers size={18} />
              </div>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                Impute null fields by automatically computing column averages (mean) or safely drop records with missing cells.
              </p>
            </div>
